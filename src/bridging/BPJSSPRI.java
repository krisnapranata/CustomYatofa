...
public class BPJSSPRI extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnKirimBerkas.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnKirimBerkas.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnKirimBerkas.setName("MnKirimBerkas"); // NOI18N
        MnKirimBerkas.setPreferredSize(new java.awt.Dimension(200, 26));
        ...
        DTPTanggalSurat1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2023" }));
        ...
        DTPTanggalSurat2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2023" }));
        ...
        DTPTanggalKontrol1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2023" }));
        ...
        DTPTanggalKontrol2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2023" }));
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2023" }));
        ...
        TanggalKontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2023" }));
...
//                tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(),"SPRI","pages/upload/"+namapasien+"_"+tbObat.getValueAt(tbObat.getSelectedRow(),2).toString()+spri
//            });
            customsimrs.SimpanBerkasKeTabelBerkas(tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(), 
                    koneksiDB.KODESPRI(), 
                    tbObat.getValueAt(tbObat.getSelectedRow(),3).toString(), 
                    tbObat.getValueAt(tbObat.getSelectedRow(),2).toString(), 
                    "SPRI.pdf");
            
            customsimrs.MyReportQryPDFBaru("rptBridgingSuratPRI2.jasper","report","::[ Data Surat PRI VClaim ]::",
                    "select bridging_surat_pri_bpjs.no_rawat,bridging_surat_pri_bpjs.no_kartu,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,"+
                    "pasien.jk,bridging_surat_pri_bpjs.diagnosa,bridging_surat_pri_bpjs.tgl_surat,bridging_surat_pri_bpjs.no_surat,"+
                    "bridging_surat_pri_bpjs.tgl_rencana,bridging_surat_pri_bpjs.kd_dokter_bpjs,bridging_surat_pri_bpjs.nm_dokter_bpjs,"+
                    "bridging_surat_pri_bpjs.kd_poli_bpjs,bridging_surat_pri_bpjs.nm_poli_bpjs from reg_periksa inner join bridging_surat_pri_bpjs "+
                    "on bridging_surat_pri_bpjs.no_rawat=reg_periksa.no_rawat inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "where bridging_surat_pri_bpjs.no_surat='"+NoSurat.getText()+"'",
                    tbObat.getValueAt(tbObat.getSelectedRow(),3).toString(), 
                    tbObat.getValueAt(tbObat.getSelectedRow(),2).toString(), 
                    "SPRI.pdf", param);
//            Valid.MyReportqrypdfSPRIBaru("rptBridgingSuratPRI2.jasper","report","::[ Data Surat PRI VClaim ]::",
//                    "select bridging_surat_pri_bpjs.no_rawat,bridging_surat_pri_bpjs.no_kartu,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,"+
//                    "pasien.jk,bridging_surat_pri_bpjs.diagnosa,bridging_surat_pri_bpjs.tgl_surat,bridging_surat_pri_bpjs.no_surat,"+
//                    "bridging_surat_pri_bpjs.tgl_rencana,bridging_surat_pri_bpjs.kd_dokter_bpjs,bridging_surat_pri_bpjs.nm_dokter_bpjs,"+
//                    "bridging_surat_pri_bpjs.kd_poli_bpjs,bridging_surat_pri_bpjs.nm_poli_bpjs from reg_periksa inner join bridging_surat_pri_bpjs "+
...
//                    "where bridging_surat_pri_bpjs.no_surat='"+NoSurat.getText()+"'",param);              
            this.setCursor(Cursor.getDefaultCursor());
//            System.out.println(tbObat.getValueAt(tbObat.getSelectedRow(),1).toString());
        }else{
            JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data Surat PRI yang mau dicetak...!!!!");
            BtnBatal.requestFocus();
        }  
