...
public class koneksiDB {
    ...
    /*MENU TAMBAHAN UPLAOD BERKAS LEWAT SFTP
    */
    public static String USERSFTPUPLOADBERKAS(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=EnkripsiAES.decrypt(prop.getProperty("USERSFTPUPLOADBERKAS"));
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String PASSWORDSFTPUPLOADBERKAS(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=EnkripsiAES.decrypt(prop.getProperty("PASSWORDSFTPUPLOADBERKAS"));
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String PORTSFTPUPLOADBERKAS(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=EnkripsiAES.decrypt(prop.getProperty("PORTSFTPUPLOADBERKAS"));
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String WORKINGDIRSFTPUPLOADBERKAS(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("WORKINGDIRSFTPUPLOADBERKAS");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String UPLOADBERKASOTOMATIS(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("UPLOADBERKASOTOMATIS");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String KODEEKLAIM(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("KODEEKLAIM");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String KODERESUME(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("KODERESUME");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String KODELAPORANOPERASI(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("KODELAPORANOPERASI");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String KODELAPORANANESTESI(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("KODELAPORANANESTESI");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String KODESEP(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("KODESEP");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String KODESPRI(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("KODESPRI");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String KODELAB(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("KODELAB");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String KODEECHO(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("KODEECHO");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String KODEEKG(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("KODEEKG");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String KODERADIOLOGI(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("KODERADIOLOGI");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String KODEEVALUASIOBAT(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("KODEEVALUASIOBAT");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String KODEBILLING(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("KODEBILLING");
        }catch(Exception e){
            var=""; 
        }
        return var;
