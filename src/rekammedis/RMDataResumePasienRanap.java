...
public final class RMDataResumePasienRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Kontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-06-2024 05:08:43" }));
    ...
    private void MnKirimBerkasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKirimBerkasActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            //tambahan baris baru
//            String resume = "_resume_ranap.pdf";
//            param.put("resume", resume);
//            String nm_pasien = tbObat.getValueAt(tbObat.getSelectedRow(),2).toString();
//            String namapasien = nm_pasien.replace(" ", "_");
//            param.put("nmpasien",namapasien);
//            //tambahan baris baru
//            param.put("norm",tbObat.getValueAt(tbObat.getSelectedRow(),1).toString());
...
//                TNoRw.getText(),"RESUME","pages/upload/"+namapasien+"_"+tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()+resume
//            });
            customsimrs.SimpanBerkasKeTabelBerkas(tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(), koneksiDB.KODERESUME(), tbObat.getValueAt(tbObat.getSelectedRow(),2).toString(), tbObat.getValueAt(tbObat.getSelectedRow(),1).toString(), "resume_ranap.pdf");
            customsimrs.MyReportPDFBaru("rptLaporanResumeRanap.jasper","report","::[ Laporan Resume Pasien ]::", tbObat.getValueAt(tbObat.getSelectedRow(),2).toString(), tbObat.getValueAt(tbObat.getSelectedRow(),1).toString(), "resume_ranap.pdf", param);
//            Valid.MyReportPDFResumeRanapBaru("rptLaporanResumeRanap.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
