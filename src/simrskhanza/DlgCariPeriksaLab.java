...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnKirimBerkas.setPreferredSize(new java.awt.Dimension(190, 26));
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    /*
    Menambahkn Button Kirim Berkas Otomatis
    */
            ...
            try {
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        //                        String nrawat = no_rawat.replace("/", "");
                        //                        param.put("no_periksa",nrawat);
                        param.put("noperiksa",rs.getString("no_rawat"));
                        param.put("norm",rs.getString("no_rkm_medis"));
                        param.put("namapasien",rs.getString("nm_pasien"));
...
//                                param.put("nm_pasien",nama_pasien);
                                String jam_periksa = rs.getString("jam");
                                String jperiksa = jam_periksa.replace(":", "");
//                                param.put("jamp",jperiksa);
                                customsimrs.SimpanBerkasKeTabelBerkas(rs.getString("no_rawat"), koneksiDB.KODELAB(), rs.getString("nm_pasien"), rs.getString("no_rkm_medis")+"_"+jperiksa, "lab.pdf");
//                                Valid.MyReportPDFLabBaru("rptPeriksaLabPermintaan.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);
//                                Sequel.menyimpan3("berkas_digital_perawatan", "?,?,?","No.Rawat",3,new String[]{
//                                    rs.getString("no_rawat"),"LAB","pages/upload/"+nama_pasien+"_"+rs.getString("no_rkm_medis")+"_"+jperiksa+lab
//                                });
                                customsimrs.MyReportPDFBaru("rptPeriksaLabPermintaan.jasper","report","::[ Pemeriksaan Laboratorium ]::", rs.getString("nm_pasien"), rs.getString("no_rkm_medis")+"_"+jperiksa, "lab.pdf", param);
                            }else{
//                                String lab = "_lab.pdf";
//                                param.put("lab", lab);
//                                String nm_pasien = rs.getString("nm_pasien");
...
//                                param.put("nm_pasien",nama_pasien);
                                ...
                                customsimrs.SimpanBerkasKeTabelBerkas(rs.getString("no_rawat"), koneksiDB.KODELAB(), rs.getString("nm_pasien"), rs.getString("no_rkm_medis")+"_"+jperiksa, "lab.pdf");
//                                
//                                Valid.MyReportPDFLabBaru("rptPeriksaLab.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);
//                                Sequel.menyimpan3("berkas_digital_perawatan", "?,?,?","No.Rawat",3,new String[]{
//                                    rs.getString("no_rawat"),"LAB","pages/upload/"+nama_pasien+"_"+rs.getString("no_rkm_medis")+"_"+jperiksa+lab
//                                });
                                customsimrs.MyReportPDFBaru("rptPeriksaLab.jasper","report","::[ Pemeriksaan Laboratorium ]::", rs.getString("nm_pasien"), rs.getString("no_rkm_medis")+"_"+jperiksa, "lab.pdf", param);
                            
                            }
                            /*
                            Sequel.menyimpan3("berkas_digital_perawatan", "?,?,?","No.Rawat",3,new String[]{
                                rs.getString("no_rawat"),"LAB","pages/upload/"+nama_pasien+"("+rs.getString("no_rkm_medis")+")_"+jperiksa+lab
                            });*/
