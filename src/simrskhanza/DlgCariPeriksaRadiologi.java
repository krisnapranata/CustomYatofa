...
public class DlgCariPeriksaRadiologi extends javax.swing.JDialog {
    ...
    //Tambahan Baru
    private CustomSIMRS customsimrs = new CustomSIMRS();
    ...
    private void initComponents() {
        ...
        MnKirimBerkas = new javax.swing.JMenuItem();
        ...
        BtnKirimBerkas = new widget.Button();
        ...
        MnKirimBerkas.setBackground(new java.awt.Color(255, 255, 254));
        MnKirimBerkas.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnKirimBerkas.setForeground(new java.awt.Color(50, 50, 50));
        MnKirimBerkas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnKirimBerkas.setText("Kirim Berkas");
        MnKirimBerkas.setName("MnKirimBerkas"); // NOI18N
        MnKirimBerkas.setPreferredSize(new java.awt.Dimension(220, 28));
        MnKirimBerkas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnKirimBerkasActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnKirimBerkas);
        ...
        TabData.setMinimumSize(new java.awt.Dimension(370, 90));
        ...
        HasilPeriksa.setMargin(new java.awt.Insets(2, 8, 2, 8));
        ...
        panelGlass6.setPreferredSize(new java.awt.Dimension(120, 40));

        btnAmbilPhoto1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnAmbilPhoto1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btnAmbilPhoto1.setName("btnAmbilPhoto1"); // NOI18N
        btnAmbilPhoto1.setPreferredSize(new java.awt.Dimension(90, 30));
        ...
        BtnSimpan.setFont(new java.awt.Font("Tahoma", 1, 9)); // NOI18N
        ...
        BtnPrint1.setPreferredSize(new java.awt.Dimension(80, 30));
        ...
        BtnKirimBerkas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Uparrow2.png"))); // NOI18N
        BtnKirimBerkas.setMnemonic('T');
        BtnKirimBerkas.setText("Kirim Berkas");
        BtnKirimBerkas.setToolTipText("Alt+K");
        BtnKirimBerkas.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnKirimBerkas.setName("BtnKirimBerkas"); // NOI18N
        BtnKirimBerkas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKirimBerkasActionPerformed(evt);
            }
        });
        BtnKirimBerkas.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnKirimBerkasKeyPressed(evt);
            }
        });
        panelGlass6.add(BtnKirimBerkas);
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void BtnKirimBerkasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimBerkasActionPerformed
        if(Kd2.getText().equals("")){
               JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data terlebih dahulu...!!!!"); 
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            ...
            try {
                ...
                try {
                    ...
                    System.out.println("simrskhanza.DlgCariPeriksaRadiologi.BtnKirimBerkasActionPerformed() ps2 : "+e);
                } finally{
                    if(rs2!=null){
                        rs2.close();
                    }
            ...
            param.put("norm",NoRM.getText());
            param.put("nrm",NoRM.getText());            
            String nm_pasien = Sequel.cariIsi("select pasien.nm_pasien from pasien where pasien.no_rkm_medis=? ",NoRM.getText());
//            String nama_pasien = nm_pasien.replace(" ", "_");
            param.put("namapasien",Sequel.cariIsi("select pasien.nm_pasien from pasien where pasien.no_rkm_medis=? ",NoRM.getText()));
//            String namapasien = nm_pasien.replace(" ", "_");
//            param.put("nmpasien",namapasien);
            param.put("jkel",Jk.getText());
            param.put("umur",Umur.getText());
            param.put("lahir",Sequel.cariIsi("select DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y') from pasien where pasien.no_rkm_medis=? ",NoRM.getText()));
            param.put("pengirim",tbDokter.getValueAt(tbDokter.getSelectedRow(),5).toString());
            ...
            String jam_periksa = tbDokter.getValueAt(tbDokter.getSelectedRow(),4).toString();
            String jperiksa = jam_periksa.replace(":", "");
            param.put("jamp",jperiksa);
            
//            String radilogi = "_radiologi.pdf";
//            param.put("radiologi", radilogi);
//            
//            param.put("host", koneksiDB.HOSTHYBRIDWEB());
//            param.put("usersftp", koneksiDB.USERSFTPUPLOADBERKAS());
//            param.put("passwordsftp", koneksiDB.PASSWORDSFTPUPLOADBERKAS());
//            param.put("portsftp", koneksiDB.PORTSFTPUPLOADBERKAS());
//            param.put("workingdirsftp", koneksiDB.WORKINGDIRSFTPUPLOADBERKAS());
...
//            Valid.MyReportPDFRadiologi("rptPeriksaRadiologi.jasper","report","::[ Pemeriksaan Radiologi ]::",param);
//            Sequel.menyimpan3("berkas_digital_perawatan", "?,?,?","No.Rawat",3,new String[]{
//                   norawat,"RAD","pages/upload/"+nama_pasien+"_"+NoRM.getText()+"_"+jperiksa+radilogi
//             });
            customsimrs.SimpanBerkasKeTabelBerkas(Kd2.getText(), koneksiDB.KODERADIOLOGI(), nm_pasien, NoRM.getText()+"_"+jperiksa, "radiologi.pdf");
            customsimrs.MyReportPDFBaru("rptPeriksaRadiologi.jasper","report","::[ Pemeriksaan Radiologi ]::", nm_pasien, NoRM.getText()+"_"+jperiksa, "radiologi.pdf", param);
//            pilihan = (String)JOptionPane.showInputDialog(null,"Silahkan pilih hasil pemeriksaan..!","Hasil Pemeriksaan",JOptionPane.QUESTION_MESSAGE,null,new Object[]{"Model 1","Model 2", "Model 3","PDF Model 1","PDF Model 2","PDF Model 3"},"Model 1");
//            switch (pilihan) {
//                case "Model 1":
//                      Valid.MyReport("rptPeriksaRadiologi.jasper","report","::[ Pemeriksaan Radiologi ]::",param);
...
//            }                        
    ...
    }//GEN-LAST:event_BtnKirimBerkasActionPerformed

    private void BtnKirimBerkasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKirimBerkasKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnKirimBerkasKeyPressed

    private void MnKirimBerkasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKirimBerkasActionPerformed
        if(Kd2.getText().equals("")){
               JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data terlebih dahulu...!!!!"); 
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            ...
            customsimrs.SimpanBerkasKeTabelBerkas(Kd2.getText(), koneksiDB.KODERADIOLOGI(), nm_pasien, NoRM.getText()+"_"+jperiksa, "radiologi.pdf");
            customsimrs.MyReportPDFBaru("rptPeriksaRadiologi.jasper","report","::[ Pemeriksaan Radiologi ]::", 
                    nm_pasien, NoRM.getText()+"_"+jperiksa, 
                    "radiologi.pdf", 
                    param);
    ...
    }//GEN-LAST:event_MnKirimBerkasActionPerformed
    ...
    */
    ...
    private widget.Button BtnKirimBerkas;
    ...
    private javax.swing.JMenuItem MnKirimBerkas;
