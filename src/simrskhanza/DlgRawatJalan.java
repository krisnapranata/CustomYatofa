...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnSimpanKirim = new widget.Button();
...
//        BtnSimpanKirim.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/save-16x16.png"))); 
//        BtnSimpanKirim.setMnemonic('M');
//        BtnSimpanKirim.setText("Simpan&Kirim");
//        BtnSimpanKirim.setToolTipText("Alt+A");
//        BtnSimpanKirim.setName("BtnSimpanKirim"); 
//        BtnSimpanKirim.setPreferredSize(new java.awt.Dimension(100, 30));
//        BtnSimpanKirim.addActionListener(new java.awt.event.ActionListener() {
//            public void actionPerformed(java.awt.event.ActionEvent evt) {
//                BtnSimpanKirimActionPerformed(evt);
//            }
//        });
        BtnSimpanKirim.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/save-16x16.png"))); // NOI18N
        BtnSimpanKirim.setText("Simpan & Resume");
        BtnSimpanKirim.setFocusPainted(false);
        BtnSimpanKirim.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnSimpanKirim.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnSimpanKirim.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSimpanKirim.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnSimpanKirim.setName("BtnSimpanKirim"); // NOI18N
        BtnSimpanKirim.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnSimpanKirim.setRoundRect(false);
        BtnSimpanKirim.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSimpanKirimActionPerformed(evt);
            }
        ...
        BtnSimpanKirim.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnSimpanKirimKeyPressed(evt);
            }
        });
        panelGlass8.add(BtnSimpanKirim);
    ...
    private void BtnSimpanKirimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            Valid.textKosong(TNoRw, "No.Rawat");
        } else {
            if (akses.getkode().equals("Admin Utama")) {
    ...
    private void BtnSimpanKirimKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            BtnSimpanKirimActionPerformed(null);
        } else {
            if (TabRawat.getSelectedIndex() == 0) {
                Valid.pindah(evt, BtnSeekDokter, BtnBatal);
            } else if (TabRawat.getSelectedIndex() == 1) {
    ...
    private widget.Button BtnSimpanKirim;
    ...
    public void isCek() {
        tinggi = 0;
        BtnSimpan.setEnabled(akses.gettindakan_ralan());
        BtnSimpanKirim.setEnabled(akses.gettindakan_ralan());
        BtnHapus.setEnabled(akses.gettindakan_ralan());
        BtnEdit.setEnabled(akses.gettindakan_ralan());
        BtnPrint.setEnabled(akses.gettindakan_ralan());
                    ...
                    if (KdPeg.getText().trim().equals("") || TPegawai.getText().trim().equals("")) {
                        ...
                        if (akses.getkode().equals("Admin Utama")) {
                            if (Sequel.menyimpantf("pemeriksaan_ralan", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 21, new String[]{
                                ...
                                /*
                                // memanggil method otomatis resume
                                */
                                //SoapOtomatisResume();
...
//                                SoapOtomatisResume();
    ...
    private void SoapOtomatisResume() {
        /*
        // Menambah kan Otomatis Resume dari SOAP
         */
        String kodediagutama = soapKodeDiagnosaUtama(TNoRw.getText());
        String diagutama = soapDiagnosaUtama();
//        String diagutama = soapDiagnosaUtama(kodediagutama);
        String kodediagkedua = soapKodeDiagnosaKedua(TNoRw.getText());
        String diagkedua = soapDiagnosaKedua();
//        String diagkedua = soapDiagnosaKedua(kodediagkedua);
        String kodediagketiga = soapKodeDiagnosaKetiga(TNoRw.getText());
        String diagketiga = soapDiagnosaKetiga();
//        String diagketiga = soapDiagnosaKetiga(kodediagketiga);
        String kodediagkeempat = soapKodeDiagnosaKeempat(TNoRw.getText());
        String diagkeempat = soapDiagnosaKeempat();
//        String diagkeempat = soapDiagnosaKeempat(kodediagkeempat);
        
        String kodeprosutama = soapKodeProsedurUtama(TNoRw.getText());
        String prosutama = soapProsedurUtama(kodeprosutama);
        String kodeproskedua = soapKodeProsedurKedua(TNoRw.getText());
        String proskedua = soapProsedurKedua(kodeproskedua);
        String kodeprosketiga = soapKodeProsedurKetiga(TNoRw.getText());
        String prosketiga = soapProsedurKetiga(kodeprosketiga);
        String obatpulang = soapObatPulang();
//        String kodeproskeempat = soapKodeProsedurKe(TNoRw.getText());
//        String proskeempat = soapProsedurKedua(kodeprosutama);
        
        Sequel.menyimpantf("resume_pasien", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 26, new String[]{
            TNoRw.getText(),
            KdPeg.getText(),
...
//            TPenilaian.getText(),
            ...
            diagkedua,
            //KodeDiagnosaSekunder1.getText(),
            kodediagkedua,
            //DiagnosaSekunder2.getText(),
            diagketiga,
            //KodeDiagnosaSekunder2.getText(),
            kodediagketiga,
            //DiagnosaSekunder3.getText(),
            diagkeempat,
            //KodeDiagnosaSekunder3.getText(),
            kodediagkeempat,
            //DiagnosaSekunder4.getText(),
            "-",
            //KodeDiagnosaSekunder4.getText(), 
            "-",
            //ProsedurUtama.getText(),
            prosutama,
            //KodeProsedurUtama.getText(),
            kodeprosutama,
            //ProsedurSekunder1.getText(),
            proskedua,
            //KodeProsedurSekunder1.getText(),
            kodeproskedua,
            //ProsedurSekunder2.getText(), 
            prosketiga,
            //KodeProsedurSekunder2.getText(),
            kodeprosketiga,
            //ProsedurSekunder3.getText(),
            "-",
            //KodeProsedurSekunder3.getText(),
            "-",
...
//            TInstruksi.getText()
    ...
    private String soapDiagnosaUtama(){
        String diagnosautama = TPenilaian.getText();
        String[] arr = diagnosautama.split("\n");
        int size = arr.length;
        if (size <= 6 & size <= 2 ){
            diagnosautama = arr[0];
...
//    private String soapDiagnosaUtama(String kodepenyakit){
//        String diagnosautama = TPenilaian.getText();
//        String[] arr = diagnosautama.split("\n");
        
//        if (kodepenyakit.equals("-")){            
//            String diagnosautama = TPenilaian.getText();
//            return diagnosautama;
//        } else {
////            String diagnosautama = Sequel.cariIsi("select penyakit.nm_penyakit from penyakit where penyakit.kd_penyakit=?",kodepenyakit);
////            return diagnosautama;
//              String diagnosautama = TPenilaian.getText();
//              return diagnosautama;
//        }      
//    }
    ...
    private String soapKodeDiagnosaUtama(String norawat){
        String kodediagnosautama = "-";
        int jumlah = Sequel.cariInteger("select count(diagnosa_pasien.no_rawat) from diagnosa_pasien where diagnosa_pasien.no_rawat=?",norawat);
        if (jumlah > 0){
            String kodediagnosa = Sequel.cariIsi("select diagnosa_pasien.kd_penyakit from diagnosa_pasien where diagnosa_pasien.prioritas='1' AND diagnosa_pasien.no_rawat=?",norawat);
            if ("".equals(kodediagnosa)){
                return "-";
            } else {
                return Sequel.cariIsi("select diagnosa_pasien.kd_penyakit from diagnosa_pasien where diagnosa_pasien.prioritas='1' AND diagnosa_pasien.no_rawat=?",norawat);
            }
        }else{
            return kodediagnosautama;
        }   
    }
    
    private String soapDiagnosaKedua(){
        String diagnosakedua = TPenilaian.getText();
        String[] arr = diagnosakedua.split("\n");
        int size = arr.length;
...
//    private String soapDiagnosaKedua(String kodepenyakit){
//        String diagnosakedua = Sequel.cariIsi("select penyakit.nm_penyakit from penyakit where penyakit.kd_penyakit=?",kodepenyakit);
//        return diagnosakedua;
//    }
//    
//    
    private String soapKodeDiagnosaKedua(String norawat){
        String diagnosakedua = "-";
        int jumlah = Sequel.cariInteger("select count(diagnosa_pasien.no_rawat) from diagnosa_pasien where diagnosa_pasien.no_rawat=?",norawat);
        if (jumlah > 0){
            if("".equals(Sequel.cariIsi("select diagnosa_pasien.kd_penyakit from diagnosa_pasien where diagnosa_pasien.prioritas='2' AND diagnosa_pasien.no_rawat=?",norawat))){
                return "-";
            } else {
                return Sequel.cariIsi("select diagnosa_pasien.kd_penyakit from diagnosa_pasien where diagnosa_pasien.prioritas='2' AND diagnosa_pasien.no_rawat=?",norawat);
            }
        }else{
            return diagnosakedua;
        }   
    ...
    private String soapDiagnosaKetiga(){
        String diagnosaketiga = TPenilaian.getText();
        String[] arr = diagnosaketiga.split("\n");
        int size = arr.length;
        String strNumber = String.valueOf(size);
//        System.out.println(strNumber);
        if (size <= 6 & size <= 1){
            return "-";
//            diagnosaketiga = arr[2];
//            return diagnosaketiga;
        }else if(size <= 6 & size <= 2){
            diagnosaketiga = "-";
            return diagnosaketiga;
        }else if(size <= 6 & size <= 3){
...
//    private String soapDiagnosaKetiga(String kodepenyakit){
//        String diagnosaketiga = Sequel.cariIsi("select penyakit.nm_penyakit from penyakit where penyakit.kd_penyakit=?",kodepenyakit);
//        return diagnosaketiga;
//    }
//    
//    
    private String soapKodeDiagnosaKetiga(String norawat){
        String diagnosaketiga = "-";
        int jumlah = Sequel.cariInteger("select count(diagnosa_pasien.no_rawat) from diagnosa_pasien where diagnosa_pasien.no_rawat=?",norawat);
        if (jumlah > 0){
            if("".equals(Sequel.cariIsi("select diagnosa_pasien.kd_penyakit from diagnosa_pasien where diagnosa_pasien.prioritas='3' AND diagnosa_pasien.no_rawat=?",norawat))){
                return "-";
            } else {
                return Sequel.cariIsi("select diagnosa_pasien.kd_penyakit from diagnosa_pasien where diagnosa_pasien.prioritas='3' AND diagnosa_pasien.no_rawat=?",norawat);
            }
        }else{
            return diagnosaketiga;
        }   
    ...
    private String soapDiagnosaKeempat(){
        String diagnosakeempat = TPenilaian.getText();
        String[] arr = diagnosakeempat.split("\n");
        int size = arr.length;
        String strNumber = String.valueOf(size);
//        System.out.println(strNumber);
        if (size <= 6 & size <= 1){
            return "-";
//            diagnosakeempat = arr[3];
//            return diagnosakeempat;
        }else if(size <= 6 & size <= 2){
            diagnosakeempat = "-";
            return diagnosakeempat;
        }else if(size <= 6 & size <= 3){
...
//    private String soapDiagnosaKeempat(String kodepenyakit){
//        String diagnosakeempat = Sequel.cariIsi("select penyakit.nm_penyakit from penyakit where penyakit.kd_penyakit=?",kodepenyakit);
//        return diagnosakeempat;
//    }
    
    
    private String soapKodeDiagnosaKeempat(String norawat){
        String diagnosakeempat = "-";
        int jumlah = Sequel.cariInteger("select count(diagnosa_pasien.no_rawat) from diagnosa_pasien where diagnosa_pasien.no_rawat=?",norawat);
        if (jumlah > 0){
            if("".equals(Sequel.cariIsi("select diagnosa_pasien.kd_penyakit from diagnosa_pasien where diagnosa_pasien.prioritas='4' AND diagnosa_pasien.no_rawat=?",norawat))){
                return "-";
            } else {
                return Sequel.cariIsi("select diagnosa_pasien.kd_penyakit from diagnosa_pasien where diagnosa_pasien.prioritas='4' AND diagnosa_pasien.no_rawat=?",norawat);
            }
        }else{
            return diagnosakeempat;
        }   
    ...
    private String soapProsedurUtama(String kodeprosedur){
        String prosedurutama = Sequel.cariIsi("select icd9.deskripsi_pendek from icd9 where icd9.kode=?",kodeprosedur);
        return prosedurutama;
    }
    
    
    private String soapKodeProsedurUtama(String norawat){
        String prosedurutama= "-";
        int jumlah = Sequel.cariInteger("select count(prosedur_pasien.no_rawat) from prosedur_pasien where prosedur_pasien.no_rawat=?",norawat);
        if (jumlah > 0){
            if("".equals(Sequel.cariIsi("select prosedur_pasien.kode from prosedur_pasien where prosedur_pasien.prioritas='1' AND prosedur_pasien.no_rawat=?",norawat))){
                return "-";
            } else {
                return Sequel.cariIsi("select prosedur_pasien.kode from prosedur_pasien where prosedur_pasien.prioritas='1' AND prosedur_pasien.no_rawat=?",norawat);
            }
        }else{
            return prosedurutama;
        }   
    ...
    private String soapProsedurKedua(String kodeprosedur){
        String prosedurkedua = Sequel.cariIsi("select icd9.deskripsi_pendek from icd9 where icd9.kode=?",kodeprosedur);
        return prosedurkedua;
    }
    
    
    private String soapKodeProsedurKedua(String norawat){
        String prosedurkedua= "-";
        int jumlah = Sequel.cariInteger("select count(prosedur_pasien.no_rawat) from prosedur_pasien where prosedur_pasien.no_rawat=?",norawat);
        if (jumlah > 0){
            if("".equals(Sequel.cariIsi("select prosedur_pasien.kode from prosedur_pasien where prosedur_pasien.prioritas='2' AND prosedur_pasien.no_rawat=?",norawat))){
                return "-";
            } else {
                return Sequel.cariIsi("select prosedur_pasien.kode from prosedur_pasien where prosedur_pasien.prioritas='2' AND prosedur_pasien.no_rawat=?",norawat);
            }
        }else{
            return prosedurkedua;
        }   
    ...
    private String soapProsedurKetiga(String kodeprosedur){
        String prosedurketiga = Sequel.cariIsi("select icd9.deskripsi_pendek from icd9 where icd9.kode=?",kodeprosedur);
        return prosedurketiga;
    }
    
    
    private String soapKodeProsedurKetiga(String norawat){
        String prosedurketiga= "-";
        int jumlah = Sequel.cariInteger("select count(prosedur_pasien.no_rawat) from prosedur_pasien where prosedur_pasien.no_rawat=?",norawat);
        if (jumlah > 0){
            if("".equals(Sequel.cariIsi("select prosedur_pasien.kode from prosedur_pasien where prosedur_pasien.prioritas='3' AND prosedur_pasien.no_rawat=?",norawat))){
                return "-";
            } else {
                return Sequel.cariIsi("select prosedur_pasien.kode from prosedur_pasien where prosedur_pasien.prioritas='3' AND prosedur_pasien.no_rawat=?",norawat);
            }
        }else{
            return prosedurketiga;
        }   
    ...
    private String soapObatPulang(){
        String obatpulang= "-";
        if (TInstruksi.getText().equals("")){
            return obatpulang;            
        }else{
            return TInstruksi.getText();
        }   
    }
    
    private void cekDataResume(String norawat){
        int jumlah = Sequel.cariInteger("select count(resume_pasien.no_rawat) from resume_pasien where resume_pasien.no_rawat=?",norawat);
        if (jumlah > 0){
            gantiResume();
        }else{
            SoapOtomatisResume();
